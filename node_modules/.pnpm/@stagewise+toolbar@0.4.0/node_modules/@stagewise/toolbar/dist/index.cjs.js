...
function useStore(api, selector = identity) {
  const slice = panel.Rn.useSyncExternalStore(
    api.subscribe,
    () => selector(api.getState()),
    () => selector(api.getInitialState())
  );
  panel.Rn.useDebugValue(slice);
  return slice;
}
...
const createAppStore = (s2) => {
  ...
  return {
    ...
    toolbarBoxRef: pluginUi_jsxRuntime.b(),
    setToolbarBoxRef: (ref) => set(() => ({ toolbarBoxRef: ref })),
    unsetToolbarBoxRef: () => set(() => ({ toolbarBoxRef: pluginUi_jsxRuntime.b() })),
    minimized: false,
...
const ChatContext = pluginUi_jsxRuntime.K({
  chats: [],
  currentChatId: null,
  createChat: () => "",
  deleteChat: () => {
...
const ChatStateProvider = ({ children }) => {
  ...
  const [currentChatId, setCurrentChatId] = panel.d("new_chat");
  const [chatAreaState, internalSetChatAreaState] = panel.d("hidden");
  const [isPromptCreationMode, setIsPromptCreationMode] = panel.d(false);
  const [promptState, setPromptState] = panel.d("idle");
  const resetPromptState = panel.q(() => {
    setPromptState("idle");
  }, []);
  const isMinimized = useAppState((state) => state.minimized);
  const { selectedSession } = panel.useVSCode();
  panel.y(() => {
    if (isMinimized) {
  ...
  const { bridge } = panel.useSRPCBridge();
  const createChat = panel.q(() => {
  ...
  const setCurrentChat = panel.q((chatId) => {
    setCurrentChatId(chatId);
  }, []);
  const setChatInput = panel.q((chatId, value2) => {
    setChats(
      (prev) => prev.map(
  ...
  const startPromptCreation = panel.q(() => {
  ...
  const stopPromptCreation = panel.q(() => {
    setIsPromptCreationMode(false);
    setPromptState("idle");
    setChats(
      (prev) => prev.map(
  ...
  const setChatAreaState = panel.q(
    (state) => {
  ...
  const addChatDomContext = panel.q(
    (chatId, element) => {
  ...
  const removeChatDomContext = panel.q(
    (chatId, element) => {
      setChats(
        (prev) => prev.map(
          (chat) => chat.id === chatId ? {
  ...
  return /* @__PURE__ */ pluginUi_jsxRuntime.u(ChatContext.Provider, { value, children });
};
function useChatState() {
  const context = panel.x(ChatContext);
  if (!context) {
...
function useCyclicUpdate(func, frameRate) {
  const animationFrameHandle = panel.A(void 0);
  const timeBetweenFrames = panel.T(
    () => frameRate && frameRate > 0 ? 1e3 / frameRate : 0,
    [frameRate]
  );
  const lastCallFrameTime = panel.A(0);
  const update = panel.q(
    (frameTime) => {
...
const LocationContext = pluginUi_jsxRuntime.K(new URL(window.location.href));
function LocationProvider({
  children
}) {
  const [currentUrl, setCurrentUrl] = panel.d(
  ...
  return /* @__PURE__ */ pluginUi_jsxRuntime.u(LocationContext.Provider, { value: currentUrl, children });
}
function ContextProviders({
  children,
  config
}) {
  return /* @__PURE__ */ pluginUi_jsxRuntime.u(panel.ConfigProvider, { config, children: /* @__PURE__ */ pluginUi_jsxRuntime.u(LocationProvider, { children: /* @__PURE__ */ pluginUi_jsxRuntime.u(panel.SRPCBridgeProvider, { children: /* @__PURE__ */ pluginUi_jsxRuntime.u(panel.VSCodeProvider, { children: /* @__PURE__ */ pluginUi_jsxRuntime.u(panel.PluginProvider, { children: /* @__PURE__ */ pluginUi_jsxRuntime.u(ChatStateProvider, { children }) }) }) }) }) });
}
...
const $f0a04ccd8dbdd83b$export$e5c5a5f917a5871c = typeof document !== "undefined" ? panel.Rn.useLayoutEffect : () => {
};
function $8ae05eaa5c114e9c$export$7f54fc3180508a52(fn) {
  const ref = panel.A(null);
...
function $03deb23ff14920c4$export$4eaf04e54aa8eed6() {
  let globalListeners = panel.A(/* @__PURE__ */ new Map());
  let addGlobalListener = panel.q((eventTarget, type, listener, options) => {
  ...
  let removeGlobalListener = panel.q((eventTarget, type, listener, options) => {
    var _globalListeners_current_get;
    let fn = ((_globalListeners_current_get = globalListeners.current.get(listener)) === null || _globalListeners_current_get === void 0 ? void 0 : _globalListeners_current_get.fn) || listener;
    eventTarget.removeEventListener(type, fn, options);
    globalListeners.current.delete(listener);
  }, []);
  let removeAllGlobalListeners = panel.q(() => {
...
function $6179b936705e76d3$export$ae780daf29e6d456(props) {
  ...
  let [isHovered, setHovered] = panel.d(false);
  let state = panel.A({
    isHovered: false,
  ...
  panel.y($6179b936705e76d3$var$setupGlobalTouchEvents, []);
  let { addGlobalListener, removeAllGlobalListeners } = $03deb23ff14920c4$export$4eaf04e54aa8eed6();
  let { hoverProps, triggerHoverEnd } = panel.T(() => {
...
function $f7dceffc5ad7768b$export$4e328f61c538687f(props = {}) {
  ...
  let [isFocused, setFocused] = panel.d(false);
  let [isFocusVisibleState, setFocusVisible] = panel.d(() => state.current.isFocused && state.current.isFocusVisible);
  let updateState = panel.q(() => setFocusVisible(state.current.isFocused && state.current.isFocusVisible), []);
  let onFocusChange = panel.q((isFocused2) => {
...
function p() {
  let [e2] = panel.d(o$1);
  return panel.y(() => () => e2.dispose(), [e2]), e2;
}
let n = (e2, t2) => {
  s$1.isServer ? panel.y(e2, t2) : panel._(e2, t2);
};
function s(e2) {
  let r2 = panel.A(e2);
  return n(() => {
...
let o2 = function(t2) {
  let e2 = s(t2);
  return panel.Rn.useCallback((...r2) => e2.current(...r2), [e2]);
};
function E(e2) {
...
function w({ disabled: e2 = false } = {}) {
  let t2 = panel.A(null), [n2, l] = panel.d(false), r2 = p(), o$12 = o2(() => {
...
let e$1 = pluginUi_jsxRuntime.K(void 0);
function a$1() {
  return panel.x(e$1);
}
function t(...r2) {
...
function L$1() {
  let n2 = U$2();
  return panel.q((r2) => C$1({ mergeRefs: n2, ...r2 }), [n2]);
}
...
function F(n2, r2 = {}, e2, a2, s2) {
  ...
  if (r2) {
    let d2 = false, p2 = [];
    for (let [c2, T] of Object.entries(r2)) typeof T == "boolean" && (d2 = true), T === true && p2.push(c2.replace(/([A-Z])/g, (g) => `-${g.toLowerCase()}`));
    if (d2) {
      u2["data-headlessui-state"] = p2.join(" ");
      for (let c2 of p2) u2[`data-${c2}`] = "";
    }
  }
  if (t$12 === pluginUi_jsxRuntime.k && (Object.keys(m(o3)).length > 0 || Object.keys(m(u2)).length > 0)) if (!panel.mn(f2) || Array.isArray(f2) && f2.length > 1) {
...
`));
    ...
    return panel._n(f2, Object.assign({}, g, u2, y2, { ref: s2(H$2(f2), y2.ref) }, T));
  }
  return pluginUi_jsxRuntime._(t$12, Object.assign({}, h(o3, ["ref"]), t$12 !== pluginUi_jsxRuntime.k && y2, t$12 !== pluginUi_jsxRuntime.k && u2), f2);
}
function U$2() {
  let n2 = panel.A([]), r2 = panel.q((e2) => {
...
function K(n2) {
  var r2;
  return Object.assign(panel.D(n2), { displayName: (r2 = n2.displayName) != null ? r2 : n2.name });
}
function m(n2) {
...
function H$2(n2) {
  return panel.Rn.version.split(".")[0] >= "19" ? n2.props.ref : n2.ref;
}
let R = "button";
function v(a2, u2) {
  var p2;
  let l = a$1(), { disabled: e2 = l || false, autoFocus: t2 = false, ...o3 } = a2, { isFocusVisible: r2, focusProps: i2 } = $f7dceffc5ad7768b$export$4e328f61c538687f({ autoFocus: t2 }), { isHovered: s2, hoverProps: T } = $6179b936705e76d3$export$ae780daf29e6d456({ isDisabled: e2 }), { pressed: n2, pressProps: d2 } = w({ disabled: e2 }), f2 = _$1({ ref: u2, type: (p2 = o3.type) != null ? p2 : "button", disabled: e2 || void 0, autoFocus: t2 }, i2, T, d2), m2 = panel.T(() => ({ disabled: e2, hover: s2, focus: r2, active: n2, autofocus: t2 }), [e2, s2, r2, n2, t2]);
  return L$1()({ ourProps: f2, theirProps: o3, slot: m2, defaultTag: R, name: "Button" });
}
let H$1 = K(v);
let e = pluginUi_jsxRuntime.K(void 0);
function u$1() {
  return panel.x(e);
}
let u = Symbol();
...
let a = pluginUi_jsxRuntime.K(null);
...
function U$1() {
  var r2, e2;
  return (e2 = (r2 = panel.x(a)) == null ? void 0 : r2.value) != null ? e2 : void 0;
}
let S = "p";
function C(r2, e2) {
  let d2 = panel.g(), t2 = a$1(), { id: i2 = `headlessui-description-${d2}`, ...l } = r2, n$1 = f(), s2 = y(e2);
  n(() => n$1.register(i2), [i2, n$1.register]);
  let o3 = t2 || false, p2 = panel.T(() => ({ ...n$1.slot, disabled: o3 }), [n$1.slot, o3]), D = { ref: s2, ...n$1.props, id: i2 };
  return L$1()({ ourProps: D, theirProps: l, slot: p2, defaultTag: S, name: n$1.name || "Description" });
}
let _ = K(C);
Object.assign(_, {});
let c = pluginUi_jsxRuntime.K(null);
...
function I(r2) {
  var a2, e2, o3;
  let l = (e2 = (a2 = panel.x(c)) == null ? void 0 : a2.value) != null ? e2 : void 0;
  return ((o3 = void 0) != null ? o3 : 0) > 0 ? [l, ...r2].filter(Boolean).join(" ") : l;
}
let N = "label";
function G(r2, l) {
  var y$1;
  let a2 = panel.g(), e2 = P(), o$12 = u$1(), g = a$1(), { id: t2 = `headlessui-label-${a2}`, htmlFor: s2 = o$12 != null ? o$12 : (y$1 = e2.props) == null ? void 0 : y$1.htmlFor, passive: m2 = false, ...i2 } = r2, p2 = y(l);
  ...
  }), d2 = g || false, C2 = panel.T(() => ({ ...e2.slot, disabled: d2 }), [e2.slot, d2]), f2 = { ref: p2, ...e2.props, id: t2, htmlFor: s2, onClick: u2 };
...
let L = "textarea";
function H(s2, l) {
  let i2 = panel.g(), d2 = u$1(), n2 = a$1(), { id: p2 = d2 || `headlessui-textarea-${i2}`, disabled: e2 = n2 || false, autoFocus: r2 = false, invalid: a2 = false, ...T } = s2, f2 = I(), m2 = U$1(), { isFocused: o3, focusProps: u2 } = $f7dceffc5ad7768b$export$4e328f61c538687f({ autoFocus: r2 }), { isHovered: t2, hoverProps: b } = $6179b936705e76d3$export$ae780daf29e6d456({ isDisabled: e2 }), y2 = _$1({ ref: l, id: p2, "aria-labelledby": f2, "aria-describedby": m2, "aria-invalid": a2 ? "true" : void 0, disabled: e2 || void 0, autoFocus: r2 }, u2, b), x = panel.T(() => ({ disabled: e2, invalid: a2, hover: t2, focus: o3, autofocus: r2 }), [e2, a2, t2, o3, r2]);
...
const Icon = panel.D(
  ({
    ...
    return pluginUi_jsxRuntime._(
      ...
      [
        ...iconNode.map(([tag, attrs]) => pluginUi_jsxRuntime._(tag, attrs)),
...
const createLucideIcon = (iconName, iconNode) => {
  const Component = panel.D(
    ({ className, ...props }, ref) => pluginUi_jsxRuntime._(Icon, {
      ref,
      iconNode,
...
function ToolbarChatArea() {
  ...
  const textareaClassName = panel.T(
    () => panel.cn(
  ...
  const containerClassName = panel.T(() => {
    ...
    switch (chatState.promptState) {
      ...
      default:
        return panel.cn(baseClasses, "border border-border/30 bg-zinc-50/80");
    }
  }, [chatState.promptState]);
  const ctrlAltCText = useHotkeyListenerComboText(panel.HotkeyActions.CTRL_ALT_C);
  return /* @__PURE__ */ pluginUi_jsxRuntime.u(
    "div",
    {
      ...
      tabIndex: 0,
      children: [
        /* @__PURE__ */ pluginUi_jsxRuntime.u(
          J,
          {
            ref: inputRef,
        ...
        /* @__PURE__ */ pluginUi_jsxRuntime.u(
          H$1,
          {
            ...
            children: /* @__PURE__ */ pluginUi_jsxRuntime.u(Send, { className: "size-4" })
          }
        )
      ]
    }
...
const DraggableContext = pluginUi_jsxRuntime.K(
  null
);
const DraggableProvider = ({
  ...
  const [borderLocation, setBorderLocation] = panel.d({
    top: 0,
    left: 0,
    right: 0,
    bottom: 0
  ...
  const dragStartListeners = panel.A(/* @__PURE__ */ new Set());
  const dragEndListeners = panel.A(/* @__PURE__ */ new Set());
  const registerDragStart = panel.q((cb) => {
    dragStartListeners.current.add(cb);
    return () => dragStartListeners.current.delete(cb);
  }, []);
  const registerDragEnd = panel.q((cb) => {
    dragEndListeners.current.add(cb);
    return () => dragEndListeners.current.delete(cb);
  }, []);
  const emitDragStart = panel.q(() => {
    if (onDragStart) onDragStart();
    dragStartListeners.current.forEach((cb) => cb());
  }, [onDragStart]);
  const emitDragEnd = panel.q(() => {
  ...
  return /* @__PURE__ */ pluginUi_jsxRuntime.u(DraggableContext.Provider, { value: contextValue, children });
};
function useDraggable(config) {
  const providerData = panel.x(DraggableContext);
  const latestProviderDataRef = panel.A(providerData);
  panel.y(() => {
    latestProviderDataRef.current = providerData;
  }, [providerData]);
  const movingElementRef = panel.A(null);
  const dragInitiatorRef = panel.A(null);
  const [movingElementNode, setMovingElementNode] = panel.d(null);
  const [dragInitiatorNode, setDragInitiatorNode] = panel.d(null);
  const mouseToDraggableCenterOffsetRef = panel.A(null);
  const mouseDownPosRef = panel.A(null);
  const currentMousePosRef = panel.A(null);
  const isDraggingRef = panel.A(false);
  const persistedRelativeCenterRef = panel.A(config.initialRelativeCenter);
  const [currentSnapArea, setCurrentSnapArea] = panel.d(null);
  const {
    startThreshold = 3,
  ...
  const animatedPositionRef = panel.A(null);
  const velocityRef = panel.A({ x: 0, y: 0 });
  const hasAnimatedOnceRef = panel.A(false);
  panel.y(() => {
  ...
  const updateDraggablePosition = panel.q(() => {
    var _a, _b;
  ...
  const [wasDragged, setWasDragged] = panel.d(false);
  const mouseUpHandler = panel.q(
    (e2) => {
      var _a;
  ...
  const mouseMoveHandler = panel.q(
    (e2) => {
      var _a;
  ...
  const mouseDownHandler = panel.q(
    (e2) => {
      if (e2.button !== 0) {
        return;
      }
  ...
  const draggableRefCallback = panel.q((node) => {
    setMovingElementNode(node);
    movingElementRef.current = node;
  }, []);
  const handleRefCallback = panel.q((node) => {
...
function ToolbarSection({ children }) {
  return /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { className: "fade-in slide-in-from-right-2 flex max-h-sm max-w-full animate-in snap-start flex-col items-center justify-between gap-1 py-0.5", children });
}
function ToolbarItem(props) {
  return /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { className: "relative flex w-full shrink-0 items-center justify-center", children: [
    props.children,
    props.badgeContent && /* @__PURE__ */ pluginUi_jsxRuntime.u(
      "div",
      {
        className: panel.cn(
    ...
    props.statusDot && /* @__PURE__ */ pluginUi_jsxRuntime.u(
      "div",
      {
        className: panel.cn(
          "bg-rose-600",
...
const ToolbarButton = panel.D(
  ({
    ...
    const button = /* @__PURE__ */ pluginUi_jsxRuntime.u(
      H$1,
      {
        ref,
        ...props,
...
const Logo = ({
  ...
  return /* @__PURE__ */ pluginUi_jsxRuntime.u(
    "div",
    {
      ...
      children: [
        color === "gradient" && /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { className: "absolute inset-0", children: [
          /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { className: "absolute inset-0 size-full bg-gradient-to-tr from-indigo-700 via-blue-500 to-teal-500" }),
          /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { className: "absolute top-1/2 left-1/2 size-9/12 bg-[radial-gradient(circle,rgba(219,39,119,0.2)_0%,rgba(219,39,119,0)_100%)]" }),
          /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { className: "absolute right-1/2 bottom-1/2 size-full bg-[radial-gradient(circle,rgba(219,39,119,0.2)_0%,rgba(219,39,119,0)_100%)]" }),
          /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { className: "absolute top-0 left-[-10%] size-[120%] bg-[radial-gradient(circle,rgba(255,255,255,0)_60%,rgba(255,255,255,0.2)_70%)]" }),
          /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { className: "absolute top-[-20%] left-0 h-[120%] w-full bg-[radial-gradient(circle,rgba(55,48,163,0)_55%,rgba(55,48,163,0.35)_73%)]" })
        ] }),
        /* @__PURE__ */ pluginUi_jsxRuntime.u(
          "svg",
          {
            ...
            children: [
              /* @__PURE__ */ pluginUi_jsxRuntime.u("title", { children: "stagewise" }),
              /* @__PURE__ */ pluginUi_jsxRuntime.u(
                "ellipse",
                {
        ...
        /* @__PURE__ */ pluginUi_jsxRuntime.u(
          "svg",
          {
            ...
            viewBox: "0 0 2048 2048",
            children: /* @__PURE__ */ pluginUi_jsxRuntime.u(
              "path",
              {
                id: "path4",
...
const SettingsButton = ({
  onOpenPanel,
  isActive = false
}) => /* @__PURE__ */ pluginUi_jsxRuntime.u(ToolbarSection, { children: /* @__PURE__ */ pluginUi_jsxRuntime.u(ToolbarButton, { onClick: onOpenPanel, active: isActive, children: /* @__PURE__ */ pluginUi_jsxRuntime.u(Settings, { className: "size-4" }) }) });
const SettingsPanel = ({ onClose }) => {
  return /* @__PURE__ */ pluginUi_jsxRuntime.u(panel.Panel, { children: [
    /* @__PURE__ */ pluginUi_jsxRuntime.u(panel.Panel.Header, { title: "Settings" }),
    /* @__PURE__ */ pluginUi_jsxRuntime.u(panel.Panel.Content, { children: /* @__PURE__ */ pluginUi_jsxRuntime.u(ConnectionSettings, {}) }),
    /* @__PURE__ */ pluginUi_jsxRuntime.u(panel.Panel.Content, { children: /* @__PURE__ */ pluginUi_jsxRuntime.u(ProjectInfoSection, {}) })
  ] });
};
const ConnectionSettings = () => {
  ...
  const { appName } = panel.useVSCode();
  const handleRefresh = () => {
    discover();
  };
  return /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { className: "space-y-4 pb-4", children: [
    /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { children: [
      /* @__PURE__ */ pluginUi_jsxRuntime.u(
        "label",
        {
      ...
      /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { className: "flex items-center space-x-2", children: [
        /* @__PURE__ */ pluginUi_jsxRuntime.u(
          "select",
          {
            id: "session-select",
            ...
            children: [
              /* @__PURE__ */ pluginUi_jsxRuntime.u("option", { value: "", children: "Auto-detect (any window)" }),
              windows.map((window2) => /* @__PURE__ */ pluginUi_jsxRuntime.u("option", { value: window2.sessionId, children: [
                window2.displayName,
                " - Port ",
                window2.port
              ] }, window2.sessionId))
      ...
      discoveryError && /* @__PURE__ */ pluginUi_jsxRuntime.u("p", { className: "mt-1 text-red-600 text-sm", children: [
        "Error discovering windows: ",
        discoveryError
      ] }),
      !isDiscovering && windows.length === 0 && !discoveryError && /* @__PURE__ */ pluginUi_jsxRuntime.u("p", { className: "mt-1 text-gray-500 text-sm", children: "No VS Code windows found. Make sure the Stagewise extension is installed and running." })
    ] }),
    selectedSession && /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { className: "rounded-lg bg-blue-50 p-3", children: [
      /* @__PURE__ */ pluginUi_jsxRuntime.u("p", { className: "text-blue-800 text-sm", children: [
        /* @__PURE__ */ pluginUi_jsxRuntime.u("strong", { children: "Selected:" }),
        " ",
        selectedSession.displayName
      ] }),
      /* @__PURE__ */ pluginUi_jsxRuntime.u("p", { className: "mt-1 text-blue-600 text-xs", children: [
        "Session ID: ",
        selectedSession.sessionId.substring(0, 8),
        "..."
      ] })
    ] }),
    !selectedSession && /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { children: /* @__PURE__ */ pluginUi_jsxRuntime.u("p", { className: "text-gray-600 text-sm", children: [
      /* @__PURE__ */ pluginUi_jsxRuntime.u("strong", { children: "Auto-detect mode:" }),
      " Commands will be sent to any available VS Code window."
    ] }) })
  ] });
};
const ProjectInfoSection = () => /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { className: "space-y-2 text-xs text-zinc-700", children: [
  /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { className: "my-2 flex flex-wrap items-center gap-3", children: [
    /* @__PURE__ */ pluginUi_jsxRuntime.u(
      "a",
      {
  ...
  /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { className: "mt-2 text-zinc-500", children: /* @__PURE__ */ pluginUi_jsxRuntime.u("span", { children: [
...
function DisconnectedStatePanel({
  ...
  return /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { className: "rounded-lg border border-orange-200 bg-orange-50/90 p-4 shadow-lg backdrop-blur", children: [
    /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { className: "mb-3 flex items-center gap-3", children: [
      /* @__PURE__ */ pluginUi_jsxRuntime.u(WifiOff, { className: "size-5 text-orange-600" }),
      /* @__PURE__ */ pluginUi_jsxRuntime.u("h3", { className: "font-semibold text-orange-800", children: "Not Connected" })
    ] }),
    /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { className: "space-y-3 text-orange-700 text-sm", children: [
      /* @__PURE__ */ pluginUi_jsxRuntime.u("p", { children: "The stagewise toolbar isn't connected to any IDE window." }),
      discoveryError && /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { className: "rounded border border-red-200 bg-red-100 p-2 text-red-700", children: [
        /* @__PURE__ */ pluginUi_jsxRuntime.u("strong", { children: "Error:" }),
        " ",
        discoveryError
      ] }),
      /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { className: "space-y-2", children: [
        /* @__PURE__ */ pluginUi_jsxRuntime.u("p", { className: "font-medium", children: "To connect:" }),
        /* @__PURE__ */ pluginUi_jsxRuntime.u("ol", { className: "list-inside list-decimal space-y-1 pl-2 text-xs", children: [
          /* @__PURE__ */ pluginUi_jsxRuntime.u("li", { children: "Open your IDE (Cursor, Windsurf, etc.)" }),
          /* @__PURE__ */ pluginUi_jsxRuntime.u("li", { children: "Install the stagewise extension" }),
          /* @__PURE__ */ pluginUi_jsxRuntime.u("li", { children: "Make sure the extension is active" }),
          /* @__PURE__ */ pluginUi_jsxRuntime.u("li", { children: "Click refresh below" })
        ] })
      ] }),
      /* @__PURE__ */ pluginUi_jsxRuntime.u(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ pluginUi_jsxRuntime.u(RefreshCw, { className: "size-4" }),
            "Retry Connection"
          ]
        }
      ),
      /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { className: "border-orange-200 border-t pt-2", children: /* @__PURE__ */ pluginUi_jsxRuntime.u(
        "a",
        {
          href: "https://marketplace.visualstudio.com/items?itemName=stagewise.stagewise-vscode-extension",
          target: "_blank",
...
function LoadingStateContent() {
  return /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { className: "rounded-lg border border-blue-200 bg-blue-50/90 p-4 shadow-lg backdrop-blur", children: [
    /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { className: "mb-3 flex items-center gap-3", children: [
      /* @__PURE__ */ pluginUi_jsxRuntime.u(RefreshCw, { className: "size-5 animate-spin text-blue-600" }),
      /* @__PURE__ */ pluginUi_jsxRuntime.u("h3", { className: "font-semibold text-blue-800", children: "Connecting..." })
    ] }),
    /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { className: "text-blue-700 text-sm", children: /* @__PURE__ */ pluginUi_jsxRuntime.u("p", { children: "Looking for VS Code windows..." }) })
  ] });
}
function ConnectedStateButtons({
  ...
  return /* @__PURE__ */ pluginUi_jsxRuntime.u(pluginUi_jsxRuntime.k, { children: [
    /* @__PURE__ */ pluginUi_jsxRuntime.u(
      SettingsButton,
      {
    ...
    pluginsWithActions.length > 0 && /* @__PURE__ */ pluginUi_jsxRuntime.u(ToolbarSection, { children: pluginsWithActions.map((plugin) => /* @__PURE__ */ pluginUi_jsxRuntime.u(
      ToolbarButton,
      {
        ...
        children: plugin.iconSvg ? /* @__PURE__ */ pluginUi_jsxRuntime.u("span", { className: "size-4 stroke-zinc-950 text-zinc-950 *:size-full", children: plugin.iconSvg }) : /* @__PURE__ */ pluginUi_jsxRuntime.u(Puzzle, { className: "size-4" })
      },
      plugin.pluginName
    )) }),
    /* @__PURE__ */ pluginUi_jsxRuntime.u(ToolbarSection, { children: /* @__PURE__ */ pluginUi_jsxRuntime.u(
      ToolbarButton,
      {
        onClick: handleButtonClick(
        ...
        children: /* @__PURE__ */ pluginUi_jsxRuntime.u(MessageCircle, { className: "size-4 stroke-zinc-950" })
      }
    ) })
  ] });
}
function ToolbarDraggableBox() {
  const provider = panel.x(DraggableContext);
  ...
  const { windows, isDiscovering, discoveryError, discover } = panel.useVSCode();
  const isConnected = windows.length > 0;
  const [pluginBox, setPluginBox] = panel.d(null);
  const [openPanel, setOpenPanel] = panel.d(null);
  const chatState = useChatState();
  ...
  const getMinimizedIcon = () => {
    if (isLoadingState) {
      return /* @__PURE__ */ pluginUi_jsxRuntime.u(RefreshCw, { className: "size-4 animate-spin text-white" });
    }
    if (isDisconnectedState) {
      return /* @__PURE__ */ pluginUi_jsxRuntime.u(WifiOff, { className: "size-4 text-white" });
    }
    return /* @__PURE__ */ pluginUi_jsxRuntime.u(Logo, { className: "size-4.5", color: "white" });
  };
  return /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { ref: draggable.draggableRef, className: "absolute p-0.5", children: [
    /* @__PURE__ */ pluginUi_jsxRuntime.u(
      "div",
      {
        className: panel.cn(
        ...
        children: [
          /* @__PURE__ */ pluginUi_jsxRuntime.u(
            "div",
            {
              ...
              children: [
                isLoadingState && /* @__PURE__ */ pluginUi_jsxRuntime.u(LoadingStateContent, {}),
                isDisconnectedState && /* @__PURE__ */ pluginUi_jsxRuntime.u(
                ...
                isConnectedState && openPanel === "settings" && /* @__PURE__ */ pluginUi_jsxRuntime.u(SettingsPanel, { onClose: () => setOpenPanel(null) }),
                isConnectedState && (pluginBox == null ? void 0 : pluginBox.component)
              ]
            }
          ),
          isConnectedState && /* @__PURE__ */ pluginUi_jsxRuntime.u(
            "div",
            {
              className: panel.cn(
              ...
              children: /* @__PURE__ */ pluginUi_jsxRuntime.u(ToolbarChatArea, {})
            }
          )
        ]
      }
          ...
          /* @__PURE__ */ pluginUi_jsxRuntime.u(
            "div",
            {
              ...
              children: [
                ...
                (isLoadingState || isDisconnectedState) && /* @__PURE__ */ pluginUi_jsxRuntime.u(ToolbarSection, { children: /* @__PURE__ */ pluginUi_jsxRuntime.u(
                  ToolbarButton,
                  {
                    ...
                    children: [
                      isLoadingState && /* @__PURE__ */ pluginUi_jsxRuntime.u(RefreshCw, { className: "size-4 animate-spin" }),
                      isDisconnectedState && /* @__PURE__ */ pluginUi_jsxRuntime.u(RefreshCw, { className: "size-4" })
                    ]
                  }
                ) }),
                /* @__PURE__ */ pluginUi_jsxRuntime.u(ToolbarSection, { children: /* @__PURE__ */ pluginUi_jsxRuntime.u(
                  ToolbarButton,
                  {
                    ...
                    children: draggable.position.isTopHalf ? /* @__PURE__ */ pluginUi_jsxRuntime.u(ChevronUp, { className: "size-4" }) : /* @__PURE__ */ pluginUi_jsxRuntime.u(ChevronDown, { className: "size-4" })
                  }
                ) })
              ]
            }
...
function ToolbarArea() {
  const containerRef = panel.A(null);
  return /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { className: "absolute size-full", children: /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { className: "absolute inset-4", ref: containerRef, children: /* @__PURE__ */ pluginUi_jsxRuntime.u(
    DraggableProvider,
    {
      containerRef,
      snapAreas: {
      ...
      children: /* @__PURE__ */ pluginUi_jsxRuntime.u(ToolbarDraggableBox, {})
    }
  ) }) });
}
function ElementSelector(props) {
  const lastHoveredElement = panel.A(null);
  const handleMouseMove = panel.q(
    (event) => {
      const target = event.target;
      if (target.closest(".companion")) return;
      const refElement = panel.getElementAtPoint(event.clientX, event.clientY);
  ...
  const handleMouseLeave = panel.q(() => {
    lastHoveredElement.current = null;
    props.onElementUnhovered();
  }, [props]);
  const handleMouseClick = panel.q(() => {
...
function useWindowSize() {
  const [size, setSize] = panel.d({
    width: window.innerWidth,
    height: window.innerHeight
  });
  const handleResize = panel.q(
    () => setSize({
      width: window.innerWidth,
      height: window.innerHeight
    }),
...
function ContextItemProposal({
  ...
  const boxRef = panel.A(null);
  const windowSize = useWindowSize();
  const { plugins } = panel.usePlugins();
  const hoveredElementPluginContext = panel.T(() => {
  ...
  const updateBoxPosition = panel.q(() => {
    if (boxRef.current) {
      if (refElement) {
  ...
  return /* @__PURE__ */ pluginUi_jsxRuntime.u(
    "div",
    {
      ...
      ref: boxRef,
      children: [
        /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { className: "absolute top-0.5 left-0.5 flex w-full flex-row items-start justify-start gap-1", children: [
          /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { className: "flex flex-row items-center justify-center gap-0.5 overflow-hidden rounded-md bg-zinc-700/80 px-1 py-0 font-medium text-white text-xs", children: /* @__PURE__ */ pluginUi_jsxRuntime.u("span", { className: "truncate", children: refElement.tagName.toLowerCase() }) }),
          hoveredElementPluginContext.map((plugin) => {
            var _a;
            return /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { className: "flex flex-row items-center justify-center gap-0.5 overflow-hidden rounded-md bg-zinc-700/80 px-1 py-0 font-medium text-white text-xs", children: [
              /* @__PURE__ */ pluginUi_jsxRuntime.u("span", { className: "size-3 shrink-0 stroke-white text-white *:size-full", children: (_a = plugins.find((p2) => p2.pluginName === plugin.pluginName)) == null ? void 0 : _a.iconSvg }),
              /* @__PURE__ */ pluginUi_jsxRuntime.u("span", { className: "truncate", children: plugin.context.annotation })
            ] });
          })
        ] }),
        /* @__PURE__ */ pluginUi_jsxRuntime.u(Plus, { className: "size-6 drop-shadow-black drop-shadow-md" })
      ]
    }
  );
}
function ContextItem({ refElement, ...props }) {
  ...
  useCyclicUpdate(updateBoxPosition, 30);
  const chatState = useChatState();
  const handleDeleteClick = panel.q(() => {
  ...
  return /* @__PURE__ */ pluginUi_jsxRuntime.u(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ pluginUi_jsxRuntime.u(Trash2, { className: "size-6 drop-shadow-black drop-shadow-md" })
      ]
    }
  );
}
function SelectorCanvas() {
  ...
  const contextElements = panel.T(() => {
    return (currentChat == null ? void 0 : currentChat.domContextElements) || [];
  }, [currentChat]);
  const [hoveredElement, setHoveredElement] = panel.d(
    null
  );
  const addElementToContext = panel.q(
    (el) => {
  ...
  return /* @__PURE__ */ pluginUi_jsxRuntime.u(pluginUi_jsxRuntime.k, { children: [
    hoveredElement && /* @__PURE__ */ pluginUi_jsxRuntime.u(ContextItemProposal, { refElement: hoveredElement }),
    /* @__PURE__ */ pluginUi_jsxRuntime.u(
      ElementSelector,
      {
    ...
    contextElements.map((el) => /* @__PURE__ */ pluginUi_jsxRuntime.u(ContextItem, { refElement: el.element, pluginContext: el.pluginContext }))
  ] });
}
function DesktopLayout() {
  return /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { className: panel.cn("fixed inset-0 h-screen w-screen"), children: [
    /* @__PURE__ */ pluginUi_jsxRuntime.u(SelectorCanvas, {}),
    /* @__PURE__ */ pluginUi_jsxRuntime.u(ToolbarArea, {})
  ] });
}
...
function FocusLock() {
  const focusInCompanion = panel.A(false);
  panel.y(() => {
  ...
  useEventListener(
    "focusin",
    (event) => {
      if (event.target.localName === panel.companionAnchorTagName) {
...
function App(config) {
  ...
  return /* @__PURE__ */ pluginUi_jsxRuntime.u(pluginUi_jsxRuntime.k, { children: [
    /* @__PURE__ */ pluginUi_jsxRuntime.u(FocusLock, {}),
    /* @__PURE__ */ pluginUi_jsxRuntime.u(
      ClickBlocker,
      {
    ...
    /* @__PURE__ */ pluginUi_jsxRuntime.u(ContextProviders, { config, children: [
      /* @__PURE__ */ pluginUi_jsxRuntime.u(HotkeyListener, {}),
      /* @__PURE__ */ pluginUi_jsxRuntime.u(VisibilityManager, { children: /* @__PURE__ */ pluginUi_jsxRuntime.u(DesktopLayout, {}) })
    ] })
  ] });
}
function initToolbar(config) {
  ...
  if (document.body.querySelector(panel.companionAnchorTagName)) {
    console.warn(
  ...
  const shadowDomAnchor = document.createElement(panel.companionAnchorTagName);
  ...
  pluginUi_jsxRuntime.E(pluginUi_jsxRuntime._(App, config), shadowDomAnchor);
}
