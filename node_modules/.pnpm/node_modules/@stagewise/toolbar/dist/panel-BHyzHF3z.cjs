...
var t, r$1, u, i, o = 0, f = [], c = pluginUi_jsxRuntime.l, e = c.__b, a = c.__r, v = c.diffed, l = c.__c, m = c.unmount, s = c.__;
function p(n, t2) {
...
function M(n, e2) {
  ...
  function u2(e3) {
    return this.shouldComponentUpdate = r2, pluginUi_jsxRuntime._(n, e3);
  }
  return u2.displayName = "Memo(" + (n.displayName || n.name) + ")", u2.prototype.isReactComponent = true, u2.__f = true, u2;
}
(N.prototype = new pluginUi_jsxRuntime.x()).isPureReactComponent = true, N.prototype.shouldComponentUpdate = function(n, t2) {
  return E(this.props, n) || E(this.state, t2);
};
var T = pluginUi_jsxRuntime.l.__b;
pluginUi_jsxRuntime.l.__b = function(n) {
...
var L = function(n, t2) {
  return null == n ? null : pluginUi_jsxRuntime.H(pluginUi_jsxRuntime.H(n).map(t2));
}, O = { map: L, forEach: L, count: function(n) {
  return n ? pluginUi_jsxRuntime.H(n).length : 0;
}, only: function(n) {
  var t2 = pluginUi_jsxRuntime.H(n);
  if (1 !== t2.length) throw "Children.only";
  return t2[0];
}, toArray: pluginUi_jsxRuntime.H }, F = pluginUi_jsxRuntime.l.__e;
pluginUi_jsxRuntime.l.__e = function(n, t2, e2, r2) {
  if (n.then) {
    for (var u2, o2 = t2; o2 = o2.__; ) if ((u2 = o2.__c) && u2.__c) return null == t2.__e && (t2.__e = e2.__e, t2.__k = e2.__k), u2.__c(n, t2);
  }
  F(n, t2, e2, r2);
};
var U = pluginUi_jsxRuntime.l.unmount;
function V(n, t2, e2) {
...
function z$1(n) {
  ...
  function o2(o3) {
    ...
    if (!r2) throw e2;
    return pluginUi_jsxRuntime._(r2, o3);
  }
...
pluginUi_jsxRuntime.l.unmount = function(n) {
  var t2 = n.__c;
  t2 && t2.__R && t2.__R(), t2 && 32 & n.__u && (n.type = null), U && U(n);
}, (P.prototype = new pluginUi_jsxRuntime.x()).__c = function(n, t2) {
  ...
  var i2 = e2.__a && pluginUi_jsxRuntime._(pluginUi_jsxRuntime.k, null, n.fallback);
  return i2 && (i2.__u &= -33), [pluginUi_jsxRuntime._(pluginUi_jsxRuntime.k, null, e2.__a ? null : n.children), i2];
};
...
function Y(n) {
  ...
  if (e2.componentWillUnmount = function() {
    pluginUi_jsxRuntime.E(null, e2.v), e2.v = null, e2.h = null;
  ...
  pluginUi_jsxRuntime.E(pluginUi_jsxRuntime._(Z, { context: e2.context }, n.__v), e2.v);
}
function $(n, e2) {
  var r2 = pluginUi_jsxRuntime._(Y, { __v: n, h: e2 });
  return r2.containerInfo = e2, r2;
}
(B.prototype = new pluginUi_jsxRuntime.x()).__a = function(n) {
  ...
  var t2 = pluginUi_jsxRuntime.H(n.children);
...
function nn(n, t2, e2) {
  return null == t2.__k && (t2.textContent = ""), pluginUi_jsxRuntime.E(n, t2), "function" == typeof e2 && e2(), n ? n.__c : null;
}
function tn(n, t2, e2) {
  return pluginUi_jsxRuntime.G(n, t2), "function" == typeof e2 && e2(), n ? n.__c : null;
}
pluginUi_jsxRuntime.x.prototype.isReactComponent = {}, ["componentWillMount", "componentWillReceiveProps", "componentWillUpdate"].forEach(function(t2) {
  Object.defineProperty(pluginUi_jsxRuntime.x.prototype, t2, { configurable: true, get: function() {
    return this["UNSAFE_" + t2];
  }, set: function(n) {
    Object.defineProperty(this, t2, { configurable: true, writable: true, value: n });
  } });
});
var en = pluginUi_jsxRuntime.l.event;
function rn() {
}
function un() {
...
pluginUi_jsxRuntime.l.event = function(n) {
...
var ln, cn$1 = { enumerable: false, configurable: true, get: function() {
  return this.class;
} }, fn = pluginUi_jsxRuntime.l.vnode;
pluginUi_jsxRuntime.l.vnode = function(n) {
  "string" == typeof n.type && function(n2) {
    ...
    "select" == e2 && u2.multiple && Array.isArray(u2.value) && (u2.value = pluginUi_jsxRuntime.H(t2.children).forEach(function(n3) {
      n3.props.selected = -1 != u2.value.indexOf(n3.props.value);
    })), "select" == e2 && null != u2.defaultValue && (u2.value = pluginUi_jsxRuntime.H(t2.children).forEach(function(n3) {
...
var an = pluginUi_jsxRuntime.l.__r;
pluginUi_jsxRuntime.l.__r = function(n) {
  an && an(n), ln = n.__c;
};
var sn = pluginUi_jsxRuntime.l.diffed;
pluginUi_jsxRuntime.l.diffed = function(n) {
  sn && sn(n);
...
function dn(n) {
  return pluginUi_jsxRuntime._.bind(null, n);
}
function mn(n) {
  return !!n && n.$$typeof === q;
}
function pn(n) {
  return mn(n) && n.type === pluginUi_jsxRuntime.k;
}
function yn(n) {
  return !!n && !!n.displayName && ("string" == typeof n.displayName || n.displayName instanceof String) && n.displayName.startsWith("Memo(");
}
function _n(n) {
  return mn(n) ? pluginUi_jsxRuntime.J.apply(null, arguments) : n;
}
function bn(n) {
  return !!n.__k && (pluginUi_jsxRuntime.E(null, n), true);
}
function Sn(n) {
...
const SRPCBridgeContext = pluginUi_jsxRuntime.K({
  bridge: null,
  isConnecting: false,
  error: null
});
function SRPCBridgeProvider({
  ...
  return /* @__PURE__ */ pluginUi_jsxRuntime.u(SRPCBridgeContext.Provider, { value: state, children });
}
...
const VSCodeContext = pluginUi_jsxRuntime.K({
  windows: [],
  isDiscovering: false,
  discoveryError: null,
...
function VSCodeProvider({ children }) {
  ...
  return /* @__PURE__ */ pluginUi_jsxRuntime.u(VSCodeContext.Provider, { value, children });
}
function useVSCode() {
  return x$1(VSCodeContext);
}
const ConfigContext = pluginUi_jsxRuntime.K({
  config: void 0
});
function ConfigProvider({
  ...
  return /* @__PURE__ */ pluginUi_jsxRuntime.u(ConfigContext.Provider, { value, children });
}
function useConfig() {
  return x$1(ConfigContext);
}
const PluginContext = pluginUi_jsxRuntime.K({
  plugins: [],
  toolbarContext: {
    sendPrompt: () => {
    }
...
function PluginProvider({
  ...
  return /* @__PURE__ */ pluginUi_jsxRuntime.u(PluginContext.Provider, { value, children });
}
function usePlugins() {
...
Panel.Header = function PanelHeader({
  ...
  return /* @__PURE__ */ pluginUi_jsxRuntime.u("header", { className: "mb-3 flex flex-col gap-1 text-zinc-950", children: [
    title && /* @__PURE__ */ pluginUi_jsxRuntime.u("h3", { className: "font-semibold text-lg ", children: title }),
    description && /* @__PURE__ */ pluginUi_jsxRuntime.u("p", { className: "font-medium text-zinc-600", children: description })
  ] });
};
Panel.Content = function PanelContent({
  children
}) {
  return /* @__PURE__ */ pluginUi_jsxRuntime.u("div", { className: "-mx-4 flex flex-col gap-2 overflow-y-auto border-border/30 border-t px-4 pt-4 text-zinc-950", children });
};
Panel.Footer = function PanelFooter({
  children
}) {
  return /* @__PURE__ */ pluginUi_jsxRuntime.u("footer", { className: "flex flex-row items-end justify-end gap-2 text-sm text-zinc-600", children });
};
exports.A = A$1;
exports.ConfigProvider = ConfigProvider;
exports.D = D;
exports.HotkeyActions = HotkeyActions;
exports.Panel = Panel;
exports.PluginProvider = PluginProvider;
exports.Rn = Rn;
exports.SRPCBridgeProvider = SRPCBridgeProvider;
exports.T = T$1;
...
exports.clsx = clsx;
exports.cn = cn;
exports.companionAnchorTagName = companionAnchorTagName;
exports.d = d;
exports.g = g$1;
exports.getElementAtPoint = getElementAtPoint;
exports.hotkeyActionDefinitions = hotkeyActionDefinitions;
exports.mn = mn;
exports.q = q$1;
exports.usePlugins = usePlugins;
exports.useSRPCBridge = useSRPCBridge;
